...
public class S2TNaiveRedirector : Redirector
{
    // naive redirector calculates the angle between the target and the current vector of the user, and shifts left or right based on that calculation
    ...
    {
        //calculate the angle
        //get user location/direction
        //get target locatin/relative direction?
        //calc
        //apply rotation
    ...
    //hey try making the thing stationary first. oh thats right this is supposed to do that. 
